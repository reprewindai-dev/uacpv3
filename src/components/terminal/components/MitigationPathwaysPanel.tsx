...
export const MitigationPathwaysPanel: React.FC = () => {
  const pathways = [
    { 
      ...
      label: 'Renewables', 
      icon: <Zap size={14} />, 
      activeClass: 'bg-yellow-400/20 border-yellow-400/40 text-yellow-400',
    ...
    { 
      ...
      label: 'Low Demand', 
      icon: <Layers size={14} />, 
      activeClass: 'bg-emerald-400/20 border-emerald-400/40 text-emerald-400',
    ...
    { 
      ...
      label: 'Net Negative', 
      icon: <Cloud size={14} />, 
      activeClass: 'bg-blue-400/20 border-blue-400/40 text-blue-400',
    ...
    { 
      ...
      icon: <Focus size={14} />, 
      activeClass: 'bg-purple-400/20 border-purple-400/40 text-purple-400',
