      ...
      <div className="relative group">
        ...
        <div className="absolute bottom-4 right-4 flex gap-3">
             <div className="flex flex-col items-end justify-center mr-2">
                ...
                <span className="text-[9px] font-mono text-cyan-400/50 font-bold uppercase tracking-widest">{selectedProvider}</span>
             </div>
            <button 
                disabled={isLocked}
      ...
      <div className="flex items-center justify-between gap-4 p-3 bg-white/5 border border-white/5 rounded-xl">
         ...
         <div className="flex items-center gap-3 pr-2">
            ...
            <div className="flex flex-col">
               ...
               <span className="text-[9px] font-mono text-emerald-400">{'< 450ms'}</span>
            </div>
         </div>
      </div>
    </div>
